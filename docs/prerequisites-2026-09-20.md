...
| Checked standard Rust paths | NOT FOUND | No executable was found at `C:\Users\W106036\.cargo\bin\rustc.exe`, `C:\Users\W106036\.cargo\bin\cargo.exe`, `C:\Program Files\Rust stable MSVC\bin\rustc.exe`, `C:\Program Files\Rust stable MSVC\bin\cargo.exe`, `C:\Program Files\Rust stable GNU\bin\rustc.exe`, or `C:\Program Files\Rust stable GNU\bin\cargo.exe`. This is not a machine-wide search. |
