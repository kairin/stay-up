...
## 19 September 2026: documentation review follow-up

The [adversarial review](adversarial-review-2026-09-19.md) retains the distinction between successful API calls and observed idle behavior.
It did not repeat the historical experiments in this note.
Current usage remains in the [README](../README.md).

The proposed [stay-watch observer](stay-watch-plan.md) will report AC and battery results separately.
...
These are design corrections. The observer implementation, capture feasibility, and runtime checks remain pending.
